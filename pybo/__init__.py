...
from .img_processing import embossing, cartoon, pencilGray, pencilColor, oilPainting, enhance  # 반드시 경로 표시해야한다. 같은 폴더 아래여도 . 찍어줘야함

dir = 'C:/DS/2023/2023-2/MultiMediaProgramming/mmp/pybo/data/'
...
def create_app():
    ...
    def capture_yolo():
        ...
        while True:
            ...
            # return 완전히 함수를 떠남
            # return과 동일하게 호출한 곳으로 값을 전달
            # yield는 잠시 함수 바깥의 코드가 실행되도록 양보하며 값을 가져가게 한 뒤 다시 코드를 계속 실행하는 방식
            yield (b'--frame\r\n'
